...
const bc, M, G = 1.,1. ,1.
const numiso = OE.NumericalIsochrone(G=G,M=M,bc=bc)
const anaiso = OE.AnalyticalIsochrone(G=G,M=M,bc=bc)
const Ω0 = OE.Ω₀(numiso)
const params = OE.OrbitalParameters(Ω₀=Ω0)
