...
"""
function ψMestel(r::Float64,R0::Float64=1.,V0::Float64=1.,eps::Float64=0.01)
...
"""
function dψMestel(r::Float64,R0::Float64=1.,V0::Float64=1.,eps::Float64=0.01)
...
"""
function d2ψMestel(r::Float64,R0::Float64=1.,V0::Float64=1.,eps::Float64=0.01)
...
"""
function d3ψMestel(r::Float64,R0::Float64=1.,V0::Float64=1.,eps::Float64=0.01)
...
"""
function d4ψMestel(r::Float64,R0::Float64=1.,V0::Float64=1.,eps::Float64=0.01)
